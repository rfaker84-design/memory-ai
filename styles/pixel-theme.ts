/* =========================================================================
   忆见 MemoryAI — Pixel Theme (Pixel Perfect)
   Single source of truth · App Store warm emotional UI
   Zero cold residue · Warm golden memory glow only
   ========================================================================= */
...
/* ── Soft Warm Shadows (pixel-perfect) ─────────────────── */
export const shadow = {
