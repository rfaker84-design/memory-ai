...
const sectionStyle = {
  border: "1px solid rgba(185,139,79,.3)",
    ...
    <main className="min-h-screen bg-[#f4ede2] px-6 py-12 text-[#302820]">
      <div className="mx-auto max-w-3xl space-y-5">
        ...
        <section id="support" style={sectionStyle}>
          ...
          <p className="mt-4 flex flex-wrap gap-x-4 gap-y-2 text-[#8a6438]">
        ...
        <section style={sectionStyle}>
          ...
          <dl className="mt-3 space-y-4 leading-7 text-[#5d4b3a]">
            ...
            <div>
              <dt className="font-semibold text-[#302820]">网络中断时，我刚写的话会怎样？</dt>
              <dd className="mt-1">未发送的文字会保留在输入框中，恢复连接后也不会自动发送。请先找回对话，再由你决定是否重试。</dd>
            </div>
            <div>
              <dt className="font-semibold text-[#302820]">怎样提交投诉、退款或数据权利请求？</dt>
        ...
        <section style={sectionStyle}>
          ...
          <ul className="mt-3 list-disc space-y-2 pl-5 leading-7 text-[#5d4b3a]">
            <li>影像默认私密。只有资料管理者主动为已人工审核通过的影像创建链接，才会出现公开只读页面。</li>
            <li>分享页面默认不被搜索收录，持续标注为 AI 生成内容，并且不提供原始文件下载。</li>
            <li>资料管理者可以在“我的 → 影像分享”随时撤销链接；撤销后，公开页面和播放都会立即不可访问。</li>
          </ul>
        </section>
      </div>
    </main>
