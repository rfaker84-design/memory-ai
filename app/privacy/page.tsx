const sections = [
  {
    title: "我们处理哪些信息",
    content: "忆见会处理你主动提交的登录信息、TA 资料、照片、声音、聊天内容、生成视频、订单与退款必要信息。照片、声音、聊天和视频属于高敏感内容；我们不会把它们当作公开资料展示。",
  },
  {
    title: "用途与边界",
    content: "这些信息只用于你选择的记忆保存、AI 内容生成、播放、客户支持与安全保障。AI 生成内容不代表真实亲人复活、具有意识或在现实中表达。我们不会将注销中的内容用于产品功能、推荐、训练或新的生成。",
  },
  {
    title: "账户注销后的时间表",
    content: "确认注销后，登录 Session、设备访问与原有 Cookie 会立即失效。TA、聊天、照片、声音和视频会停止使用，并在不晚于 7 天内从在线系统删除；COS 原文件、缩略图、派生文件和可删除的 Provider 副本会在不晚于 30 天内处理并记录删除结果；普通备份按自然轮转，最长不超过 90 天。",
  },
  {
    title: "备份、财务记录与法定保全",
