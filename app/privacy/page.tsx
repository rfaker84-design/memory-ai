const sections = [
  ...
  {
    title: "账户注销后的时间表",
    content: "确认注销后，登录 Session、设备访问与原有 Cookie 会立即失效。TA、聊天、照片和视频会停止使用，并在不晚于 7 天内从在线系统删除；COS 原文件、缩略图、派生文件和可删除的 Provider 副本会在不晚于 30 天内处理并记录删除结果；普通备份按自然轮转，最长不超过 90 天。",
  },
  {
    title: "备份、财务记录与法定保全",
